...
% PURPOSE:  This script is designed to calculate the averaged radial distribution of
...
%           "radialdistributuionfunction.xlsx".  
%             1st column: x-axis of distance in nm 
%             2nd column: g(r) for the same type of oriented phase domain
%             3rd column: g(r) for the different type of oriented phase domain
...
pixelsize = 2; % the size of each pixel (nm)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot(x*pixelsize,RDF_self_final/count_self_total,'o-','DisplayName','Same type')
plot(x*pixelsize,RDF_diff_final/count_diff_total,'o-','DisplayName','Different type')
xlabel('Displacement (nm)')
ylabel('g(r)')
%refline(0,1)
legend({'Same type','Different type'})
Outputdata=[];
Outputdata(:,1)=x(:,1)*pixelsize;
Outputdata(:,2)=RDF_self_final/count_self_total;
Outputdata(:,3)=RDF_diff_final/count_diff_total;
xlswrite ('radialdistributuionfunction.xlsx', Outputdata);
